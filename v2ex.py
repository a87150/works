...
class v2ex(object):
    ...
    def login(self):
        ...
        LoginHtml = sess.get('https://www.v2ex.com/signin', headers=self.headers)
        ...
        from_data = {
            ...
            'once': once,
            'next': '/'}
        sess.post('https://www.v2ex.com/signin', from_data, headers=self.headers)
    ...
    def balance(self, sess):
        ...
        :return: 获取签到奖励和余额
        '''
        BalanceHtml = sess.get('https://www.v2ex.com/balance',headers={'Referer': 'https://www.v2ex.com/balance'}).text
    ...
    def daily(self, sess):
        ...
        res = sess.get(RealUrl, headers={'Referer': 'https://www.v2ex.com/mission/daily'})
